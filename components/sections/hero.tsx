...
const Hero = () => {
  return (
    <section className="flex min-h-screen items-center">
      <div className="max-w-xl pt-72 md:py-32">
        <Image
          src="/images/logo.png"
          alt="Logo"
          width={160}
          height={85}
          className="h-auto w-32 sm:w-40 mx-auto lg:mx-0"
          priority
        />
        <h1 className="mt-8 text-center lg:text-start text-[2rem] leading-[1.08] sm:text-4xl md:text-5xl font-bold text-white">
        ...
        <p className="mt-6 text-base text-center lg:text-start leading-relaxed sm:text-xl md:text-2xl text-white">
